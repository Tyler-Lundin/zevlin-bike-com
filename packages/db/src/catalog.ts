export type ZevlinCatalogSeedMedia = {
  imagePath: string;
  imageAlt: string;
  label: string;
};

export type ZevlinCatalogSeedProduct = {
  id: string;
  name: string;
  description: string;
  priceCents: number;
  slug: string;
  media: ZevlinCatalogSeedMedia;
};

export const zevlinCatalog: ZevlinCatalogSeedProduct[] = [
  {
...
export function getZevlinCatalogProduct(slug: string): ZevlinCatalogSeedProduct | undefined {
